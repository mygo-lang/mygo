...
func RenderFile(packageName string, imports []Import, decls []ast.Decl) (string, error) {
	...
	var buf bytes.Buffer
	buf.WriteString("// Code generated by mygo; DO NOT EDIT.\n\n")
...
// preludeNames is the set of exported Go identifiers provided by the mygo
// prelude package that generated code may reference (enum constructors, types
// such as Option/Result/Zero, etc.).  When any declaration references one of
// these names the generated file needs a dot-import of the prelude package.
...
// NeedsPreludeImport reports whether the given declarations reference any
// prelude type or constructor, meaning the generated file requires a dot-import
// of the prelude package to compile.
func NeedsPreludeImport(decls []ast.Decl) bool {
	for _, decl := range decls {
		if containsPreludeIdent(decl) {
			return true
		}
	}
	return false
...
func containsPreludeIdent(node ast.Node) bool {
	found := false
