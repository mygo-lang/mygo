...
func ctxFreshBinding(ctx *egCtx, name string) string {
	base_925 := sanitizeIdent(name)
	count_926 := MygoIN6OptionM8UnwrapOr(MygoIT11IAssignableFN3MapGN1KN1VEGN3MapGN1KN1VEN1KN1VEM3Get(ctx.usedNames, base_925), 0)
	MygoIT11IAssignableFN3MapGN1KN1VEGN3MapGN1KN1VEN1KN1VEM3Set(ctx.usedNames, base_925, count_926+1)
	if count_926 == 0 {
		MygoIT11IAssignableFN3MapGN1KN1VEGN3MapGN1KN1VEN1KN1VEM3Set(ctx.bindings, name, base_925)
		return base_925
	}
	actual_927 := base_925 + "_" + MygoIT8ToStringFN3IntGN3IntEM8ToString(count_926)
	MygoIT11IAssignableFN3MapGN1KN1VEGN3MapGN1KN1VEN1KN1VEM3Set(ctx.bindings, name, actual_927)
	return actual_927
}
...
func ctxFreshExprTemp(ctx *egCtx) string {
	name_928 := "__mygo_expr_" + MygoIT8ToStringFN3IntGN3IntEM8ToString(ctx.exprSeq)
...
func ctxDrainPreStmts(ctx *egCtx) string {
	out_929 := joinStrings(ctx.preStmts, "\n")
	ctx.preStmts = nil
	return out_929
}
